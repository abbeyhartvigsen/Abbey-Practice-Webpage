...
//does this need to be from '.data/films.js or is this right?
// import { people } from './people.js'
// import {planets} from './planets.js'
//does this need to be from '../data/planets.js ?

// const intro = document.querySelector('.intro')
//does this need to be under films.sort((a,b)=>(a.episode_id > b.episode_id) ? 1 : -1) 
// films.sort((a,b) => (a.episode_id > b.episode_id) ? 1 : -1 )

//do I need let board = document.createElement('div)
//do I need board.className = 'board'
